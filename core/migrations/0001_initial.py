# Generated by Django 2.2.11 on 2020-04-01 11:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Manufacturer', verbose_name='manufacturer')),
            ],
            options={
                'verbose_name': 'Car',
